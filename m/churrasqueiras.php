  ...
  <body>
    <div class="container">             
       <nav class="navbar fixed-top navbar-expand-lg navbar-light " style="background-color: #00FA9A">
        ...
        <br><br><br>
        <h2 style="color:white ; background-color: black; text-align: center;">CHURRASQUEIRAS</h2>
        <?php
        /*
        ...
        ?>
         <div style="margin-left: 10px">
              ...
              <?php foreach ($vetorRegistros as $key) { 
                  ...
                  if ($key['disponibilidade'] == "amostra" && $key['tipo_produto'] == "churrasqueira") {
